  ...
  return (
    <AuthRoute>
      <div className="space-y-8">
        <h1 className="text-2xl font-bold">লোকনাথ পুজো 2025 </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500"> ধার্য মূল্য (Estimated Income)</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500">জমা মুল্য (Deposit Income)</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500">মোট খরচ (Total Expenses)</p>
